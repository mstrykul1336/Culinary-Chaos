...
public class Menu : MonoBehaviourPunCallbacks, ILobbyCallbacks
{
    ...
    public void Set1()
    {
        PlayerController.number = 1;
    }
     public void Set2()
    {
        PlayerController.number = 2;
    }
     public void Set3()
    {
        PlayerController.number = 3;
    }
     public void Set4()
    {
        PlayerController.number = 4;
    }
    ...
    void UpdateLobbyBrowserUI()
    {
        ...
        for (int x = 0; x < roomList.Count; ++x)
        {
            ...
            //roomnametext.text = roomList[x].Name;
            //playercounttext.text = roomList[x].PlayerCount + " / " + roomList[x].MaxPlayers;
